...
```{r LayeredScatterplotsTotal, echo=F, message=TRUE, fig.width = 8, fig.height = 12, results='asis'}
```  

In these two graphs, the **rate** of methane produced is shown.

```{r LayeredScatterplotsRate, echo=F, message=TRUE, fig.width = 8, fig.height = 12, results='asis'}
```
